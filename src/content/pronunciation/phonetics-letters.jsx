      ...
      <div className="line-break">
        ...
        >
          ...
          <ExampleList
            items={[
              example({
                audio: "/assets/audio/general/bats-eat-apples.mp3",
                parts: [{ part: "Bats eat apples." }],
                pt: "Morcegos comem maçã.",
              }),
              example({
              ...
              example({
                audio: "/assets/audio/general/the-man-has-a-black-hat.mp3",
