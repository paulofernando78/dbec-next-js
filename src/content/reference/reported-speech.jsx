  ...
  return <>
      ...
      <div className="line-break">
        ...
        <Section id="statements" label="Statements" heading={3}>
          ...
          part: "said (that) / told + object",
          type: "mark"
        }, " to report statements.", " ", {
          part: "Usamos said (that) / told + objeto para relatar afirmações.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "that he was busy.",
          type: "bold"
        }, " ", {
          part: "Ele disse que estava ocupado.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "that she would call.",
          type: "bold"
        }, " ", {
          part: "Ela me disse que ligaria.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="questions" label="Questions" heading={3}>
          <Paragraph value={[{
          part: "For reported questions,",
          type: "bold"
        }, " we use ", {
          part: "if / whether",
          type: "mark"
        }, " for yes/no questions and remove auxiliary inversion.", " ", {
          part: "Para perguntas no discurso indireto, usamos if / whether e removemos a inversão.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
        ...
        <Section id="tense" label="Tense Changes" heading={3}>
          ...
          part: "Present Simple → Past Simple",
          type: "mark"
        }, {
          lineBreak: true
        }, {
          part: "Present Continuous → Past Continuous",
          type: "mark"
        }, {
          lineBreak: true
        }, {
        ...
        <Section id="time-place" label="Time & Place Changes" heading={3}>
          <Paragraph value={[{
          part: "Some words change in reported speech:",
          type: "bold"
        }, {
          lineBreak: true
        }, {
        ...
        <Section id="exercises" label="Exercises" heading={3}>
          ...
          questions: [{
            ...
            options: [{
              option: "She said she was happy.",
              isCorrect: true
            }, {
              option: "She said she is happy.",
              isCorrect: false
            }, {
              option: "She told she was happy.",
              isCorrect: false
            }]
          }, {
            question: "2. He said, “I will call you.”",
            options: [{
              option: "He said he would call me.",
              isCorrect: true
            }, {
              option: "He said he will call me.",
              isCorrect: false
            }, {
              option: "He told me he will call.",
              isCorrect: false
            }]
          }, {
            question: "3. She asked, “Do you like coffee?”",
            options: [{
              option: "She asked if I liked coffee.",
              isCorrect: true
            }, {
              option: "She asked do I like coffee.",
              isCorrect: false
            }, {
              option: "She asked whether did I like coffee.",
              isCorrect: false
            }]
          }, {
            question: "4. He asked, “Where do you live?”",
            options: [{
              option: "He asked where I lived.",
              isCorrect: true
            }, {
              option: "He asked where did I live.",
              isCorrect: false
            }, {
              option: "He asked I lived where.",
              isCorrect: false
            }]
          }, {
            question: "5. She said, “I can help you.”",
            options: [{
              option: "She said she could help me.",
              isCorrect: true
            }, {
              option: "She said she can help me.",
              isCorrect: false
            }, {
              option: "She told me she can help.",
              isCorrect: false
            }]
          }, {
            question: "6. He said, “We are leaving today.”",
            options: [{
              option: "He said they were leaving that day.",
              isCorrect: true
            }, {
              option: "He said they are leaving today.",
              isCorrect: false
            }, {
              option: "He told they were leaving today.",
              isCorrect: false
            }]
          }, {
            question: "7. She asked, “Will you come tomorrow?”",
            options: [{
              option: "She asked if I would come the next day.",
              isCorrect: true
            }, {
              option: "She asked will I come tomorrow.",
              isCorrect: false
            }, {
              option: "She asked if I will come tomorrow.",
              isCorrect: false
            }]
          }, {
            question: "8. He said, “I have finished.”",
            options: [{
              option: "He said he had finished.",
              isCorrect: true
            }, {
              option: "He said he has finished.",
              isCorrect: false
            }, {
              option: "He told he finished.",
              isCorrect: false
            }]
          }, {
            question: "9. She said, “I am here.”",
            options: [{
              option: "She said she was there.",
              isCorrect: true
            }, {
              option: "She said she is here.",
              isCorrect: false
            }, {
              option: "She told she was here.",
              isCorrect: false
            }]
          }, {
            question: "10. He asked, “Can you help me?”",
            options: [{
              option: "He asked if I could help him.",
              isCorrect: true
            }, {
              option: "He asked can I help him.",
              isCorrect: false
            }, {
              option: "He asked if can I help him.",
              isCorrect: false
            }]
          }]
        }} />
