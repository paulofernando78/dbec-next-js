  ...
  return <>
      ...
      <div className="line-break">
        ...
        <Section id="basic" label="What Are Nouns?" heading={3}>
          ...
          part: "Eles respondem à pergunta: What is it?",
          type: "mark"
        }, {
          lineBreak: true
        }, {
          ...
          part: "um professor / uma professora",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Este livro é muito interessante.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="countable" label="Countable vs. Uncountable" heading={3}>
          ...
          part: "water, money, information, rice",
          type: "mark"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Eu preciso de alguma informação.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="plural" label="Plural Nouns" heading={3}>
          <Paragraph value={[{
          part: "To form the plural",
          type: "bold"
        }, " ", "we usually add -s or -es.", " ", {
          part: "Para formar o plural, geralmente adicionamos -s ou -es.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Irregular plurals:",
          type: "bold"
        }, {
          lineBreak: true
        }, {
          part: "man → men / woman → women / child → children / person → people",
          type: "mark"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Há muitas pessoas na sala.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "As crianças estão brincando lá fora.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="possessive" label="Possessive Nouns" heading={3}>
          <Paragraph value={[{
          part: "Possessive nouns",
          type: "bold"
        }, " ", "show ownership.", " ", {
          part: "Eles mostram posse.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "o livro do John",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          part: "the students' room",
          type: "mark"
        }, " ", {
          part: "a sala dos alunos",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "A sala dos professores fica no andar de cima.",
          type: "portuguese"
        }]} />
        </Section>
