  ...
  return <>
      ...
      <div className="line-break">
        ...
        <Section id="subject" label="Subject Pronouns" heading={3}>
          <Paragraph value={[{
          part: "Subject pronouns",
          type: "bold"
        }, " ", "are used as the subject of a sentence.", " ", {
          part: "Eles fazem a ação.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
        ...
        <Section id="object" label="Object Pronouns" heading={3}>
          <Paragraph value={[{
          part: "Object pronouns",
          type: "bold"
        }, " ", "are used after a verb or preposition.", " ", {
          part: "Eles recebem a ação.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
        ...
        <Section id="possessive-adjectives" label="Possessive Adjectives" heading={3}>
          <Paragraph value={[{
          part: "Possessive adjectives",
          type: "bold"
        }, " ", "come before a noun and show who owns something.", " ", {
          part: "Eles vêm antes do substantivo e mostram posse.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Ela perdeu as chaves dela.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Eles amam o cachorro deles.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="possessive" label="Possessive Pronouns" heading={3}>
          ...
          part: "This book is mine.",
          type: "bold"
        }, " ", {
          part: "Este livro é meu.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          part: "The house is hers.",
          type: "bold"
        }, " ", {
          part: "A casa é dela.",
          type: "portuguese"
