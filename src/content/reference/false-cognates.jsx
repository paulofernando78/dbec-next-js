...
export default function FalseCognates() {
  return <>
      ...
      <div className="line-break">
        ...
        href: "assist-assistir",
        label: "assist  ≠ assistir"
      }, {
        href: "attach-atacar",
        label: "attach  ≠ atacar"
      }, {
        href: "college-colegio",
        label: "college  ≠ colégio"
      }, {
        href: "data-data",
        label: "data  ≠ data"
      }, {
        href: "event-eventual",
        label: "event  ≠ eventual"
      }, {
        href: "eventually-eventualmente",
        label: "eventually  ≠ eventualmente"
      }, {
        href: "fabric-fabrica",
        label: "fabric  ≠ fábrica"
      }, {
        href: "introduce-introduzir",
        label: "introduce  ≠ introduzir"
      }, {
        href: "lecture-leitura",
        label: "lecture  ≠ leitura"
      }, {
        ...
        href: "preservative-preservativo",
        ...
        href: "underline-underscore",
        label: "underline  ≠ underscore"
      }]} />

        <Section id="actually-atualmente" label="actually ≠ atualmente" heading={3}>
          <Paragraph value={[{
          part: "actually",
          type: "bold"
        }, " ", {
        ...
        <Section id="anticipate-antecipar" label="anticipate ≠ antecipar" heading={3}>
          <Paragraph value={[{
          part: "anticipate",
          type: "bold"
        }, " ", {
        ...
        <Section id="eventually-eventualmente" label="eventually ≠ eventualmente" heading={3}>
          <Paragraph value={[{
          part: "eventually",
          type: "bold"
        }, " ", {
        ...
        <Section id="introduce-introduzir" label="introduce ≠ introduzir" heading={3}>
          <Paragraph value={[{
          part: "introduce",
          type: "bold"
        }, " ", {
        ...
        <Section id="preservative-preservativo" label="preservative ≠ preservativo" heading={3}>
          <Paragraph value={[{
          part: "preservative",
          type: "bold"
        }, " ", {
        ...
        <Section id="resume-resumo" label="resume ≠ resumo / currículo" heading={3}>
          <Paragraph value={[{
          part: "resume",
          type: "bold"
        }, " ", {
        ...
        <Section id="underline-underscore" label="underline ≠ underscore" heading={3}>
          <Paragraph value={[{
          part: "underline",
          type: "bold"
        }, " ", {
