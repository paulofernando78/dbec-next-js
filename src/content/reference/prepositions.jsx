...
export default function Prepositions() {
  return <>
      ...
      <div className="line-break">
        ...
        href: "phrases",
        label: "Common Prepositional Phrases"
      }, {
        href: "exercises",
        label: "Exercises"
      }]} />
        ...
        <Section id="basic" label="Overview" heading={3}>
          ...
          part: "in, on, at, to, from, with, by, about",
          type: "mark"
        }, {
          lineBreak: true
        }, {
          ...
          part: "As chaves estão sobre a mesa.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Nós vamos nos encontrar às 5 horas.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="time" label="Prepositions of Time" heading={3}>
          ...
          part: "Usamos in / on / at para expressões de tempo.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Meu aniversário é em maio.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Nós temos aula na sexta-feira.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "O filme começa às 8 da noite.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="place" label="Prepositions of Place" heading={3}>
          <Paragraph value={[{
          part: "Common prepositions of place:",
          type: "bold"
        }, " ", {
          part: "in / on / at / under / next to / between",
          type: "mark"
        }, {
          lineBreak: true
        }, {
          ...
          part: "O gato está debaixo da mesa.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Ela está sentada ao meu lado.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "O banco fica entre a escola e o supermercado.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="movement" label="Prepositions of Movement" heading={3}>
          <Paragraph value={[{
          part: "Prepositions of movement",
          type: "bold"
        }, " ", "show direction.", " ", {
          part: "Mostram direção.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "to, into, out of, through, across",
          type: "mark"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Eles atravessaram a rua correndo.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="phrases" label="Common Prepositional Phrases" heading={3}>
          ...
          part: "in front of, at home, on time, by accident, in charge of",
          type: "mark"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Ele quebrou o copo sem querer.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Ela está responsável pelo projeto.",
          type: "portuguese"
        }]} />
        </Section>
