  ...
  return <>
      ...
      <div className="line-break">
        ...
        <Section id="basic" label="What Are Adverbs?" heading={3}>
          ...
          part: "He runs quickly.",
          type: "bold"
        }, " ", {
          part: "Ele corre rapidamente.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          part: "She arrived yesterday.",
          type: "bold"
        }, " ", {
          part: "Ela chegou ontem.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Eles moram aqui.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          part: "I always wake up early.",
          type: "bold"
        }, " ", {
          part: "Eu sempre acordo cedo.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="manner" label="Adverbs of Manner" heading={3}>
          <Paragraph value={[{
          part: "Adverbs of manner",
          type: "bold"
        }, " ", "describe how something happens.", " ", {
          part: "Descrevem como algo acontece.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "quickly, slowly, carefully, loudly",
          type: "mark"
        }, {
          lineBreak: true
        }, {
        ...
        <Section id="time" label="Adverbs of Time" heading={3}>
          <Paragraph value={[{
          part: "Adverbs of time",
          type: "bold"
        }, " ", "tell us when something happens.", " ", {
          part: "Indicam quando algo acontece.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "today, yesterday, now, soon, later",
          type: "mark"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Nós vamos nos encontrar amanhã.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Ela terminou o trabalho ontem.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="place" label="Adverbs of Place" heading={3}>
          <Paragraph value={[{
          part: "Adverbs of place",
          type: "bold"
        }, " ", "tell us where something happens.", " ", {
          part: "Indicam onde algo acontece.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "here, there, outside, inside, everywhere",
          type: "mark"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Eles estão esperando lá fora.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="frequency" label="Adverbs of Frequency" heading={3}>
          <Paragraph value={[{
          part: "Adverbs of frequency",
          type: "bold"
        }, " ", "tell us how often something happens.", " ", {
          part: "Indicam com que frequência algo acontece.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "always, usually, often, sometimes, never",
          type: "mark"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Eu sempre tomo café de manhã.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
        ...
        <Section id="degree" label="Adverbs of Degree" heading={3}>
          <Paragraph value={[{
          part: "Adverbs of degree",
          type: "bold"
        }, " ", "show how much or how strong something is.", " ", {
          part: "Indicam intensidade ou quantidade.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "very, too, quite, enough, almost",
          type: "mark"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Este café está quente demais.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
