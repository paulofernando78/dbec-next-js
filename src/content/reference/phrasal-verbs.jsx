  ...
  return <>
      ...
      <div className="line-break">
        ...
        <Section id="basic" label="Overview" heading={3}>
          ...
          part: "Eles podem ser separáveis ou inseparáveis.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
        ...
        <Section id="daily" label="Daily Life" heading={3}>
          <Paragraph value={[{
          part: "Common daily phrasal verbs:",
          type: "bold"
        }, " ", {
          part: "wake up, get up, sit down, turn on, turn off, put on, take off",
          type: "mark"
        }, {
          lineBreak: true
        }, {
        ...
        <Section id="work" label="Work & Study" heading={3}>
          <Paragraph value={[{
          part: "Common at work/school:",
          type: "bold"
        }, " ", {
          part: "hand in, look up, carry out, set up, go over",
          type: "mark"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Por favor, entregue sua lição.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Vou procurar a palavra no dicionário.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Eles montaram um novo escritório.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="communication" label="Communication" heading={3}>
          <Paragraph value={[{
          part: "Common in communication:",
          type: "bold"
        }, " ", {
          part: "find out, get back to, speak up, point out",
          type: "mark"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Eu retorno para você amanhã.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
