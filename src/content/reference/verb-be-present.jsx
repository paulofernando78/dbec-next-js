      ...
      <div className="line-break">
        ...
        <Section id="introduction" label="Introduction" heading={3}>
          ...
          questions: [{
            ...
            options: [{
              option: "a Spanish school.",
              isCorrect: false
            }, {
              option: "the supermarket.",
              isCorrect: false
            }, {
              option: "an English school.",
              isCorrect: true
            }]
          }, {
        ...
        <Section id="presentation" label="Presentation" heading={3}>
          ...
          <Dialogue audioPlayer="/assets/audio/grammar/verb-be/presentation/dialogue.mp3" lines={[
        // Laura: Hi, I’m Laura.
        {
          speaker: "Laura:",
          text: ["Hi, I", {
        ...
        <Section id="meaning" label="Meaning" heading={4}>
          ...
          block: [{
            ...
            questions: [{
              question: "Is it talking about who he is or what he does?"
            }]
          }]
        }, {
          block: [{
          ...
          blocks: [{
            ...
            block: [{
              text: [{
                ...
                audio: "/assets/audio/grammar/verb-be/pronunciation/affirmative/im.mp3",
                part: "I"
              }, {
                part: "’m",
                type: "bold"
            ...
            block: [{
              text: [{
                ...
                audio: "/assets/audio/grammar/verb-be/pronunciation/affirmative/youre.mp3",
                part: "you"
              }, {
                part: "’re ",
                type: "bold"
            ...
            block: [{
              text: [{
                ...
                audio: "/assets/audio/grammar/verb-be/pronunciation/affirmative/hes.mp3",
                part: "he"
              }, {
                part: "’s ",
                type: "bold"
            ...
            block: [{
              text: [{
                ...
                audio: "/assets/audio/grammar/verb-be/pronunciation/affirmative/shes.mp3",
                part: "she"
              }, {
                part: "’s ",
                type: "bold"
            ...
            block: [{
              text: [{
                ...
                audio: "/assets/audio/grammar/verb-be/pronunciation/affirmative/its.mp3",
                part: "it"
              }, {
                part: "’s ",
                type: "bold"
            ...
            block: [{
              text: [{
                ...
                audio: "/assets/audio/grammar/verb-be/pronunciation/affirmative/were.mp3",
                part: "we "
              }, {
                part: "’re ",
                type: "bold"
              }, {
                part: "nós somos, estamos",
                type: "portuguese"
              }]
            }]
          }, {
            ...
            block: [{
              text: [{
                ...
                audio: "/assets/audio/grammar/verb-be/pronunciation/affirmative/theyre.mp3",
                part: "they "
              }, {
                part: "’re ",
                type: "bold"
              }, {
                part: "eles/elas são, estão",
                type: "portuguese"
              }]
            }]
          }, {
        ...
        // Negative
        {
          ...
          // am not
          {
            block: [{
              text: [{
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/i-am-not1.mp3",
                part: "I "
              }, {
                part: "am not ",
                type: "bold"
              }, {
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/i-am-not2.mp3",
                part: "I "
              }, {
                part: "am no(t) ",
                type: "bold"
            ...
            block: [{
              text: [{
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/im-not1.mp3",
                part: "I’"
              }, {
                part: "m not ",
                type: "bold"
              }, {
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/im-not2.mp3",
                part: "I’"
              }, {
                part: "m no(t) ",
                type: "bold"
          ...
          // you are not
          {
            block: [{
              text: [{
                part: "you ",
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/you-are-not1.mp3"
              }, {
                part: "are not ",
                type: "bold"
              }, {
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/you-are-not2.mp3",
                part: "you "
              }, {
                part: "are no(t) ",
                type: "bold"
          ...
          // you're not
          {
            block: [{
              text: [{
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/youre-not1.mp3",
                part: "you"
              }, {
                part: "’re not ",
                type: "bold"
              }, {
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/youre-not2.mp3",
                part: "you"
              }, {
                part: "’re no(t) ",
                type: "bold"
          ...
          // you aren't
          {
            block: [{
              text: [{
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/you-arent1.mp3"
              }, {
                part: "you "
              }, {
                part: "aren’t ",
          ...
          // he is not
          {
            block: [{
              text: [{
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/he-is-not1.mp3",
                part: "he "
              }, {
                part: "is not ",
                type: "bold"
              }, {
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/he-is-not2.mp3",
                part: "he "
              }, {
                part: "is no(t) ",
                type: "bold"
          ...
          // he's not
          {
            block: [{
              text: [{
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/hes-not1.mp3",
                part: "he"
              }, {
                part: "’s not ",
                type: "bold"
              }, {
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/hes-not2.mp3",
                part: "he"
              }, {
                part: "’s no(t) ",
                type: "bold"
          ...
          // he isn't
          {
            block: [{
              text: [{
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/he-isnt1.mp3",
                part: "he "
              }, {
                part: "isn’t ",
                type: "bold"
              }, {
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/he-isnt2.mp3",
                part: "he "
              }, {
                part: "isn’(t) ",
                type: "bold"
          ...
          // she is not
          {
            block: [{
              text: [{
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/she-is-not1.mp3",
                part: "she "
              }, {
                part: "is not ",
                type: "bold"
              }, {
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/she-is-not2.mp3",
                part: "she "
              }, {
                part: "is no(t) ",
                type: "bold"
          ...
          // she's not
          {
            block: [{
              text: [{
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/shes-not1.mp3",
                part: "she"
              }, {
                part: "’s not ",
                type: "bold"
              }, {
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/shes-not2.mp3",
                part: "she"
              }, {
                part: "’s no(t) ",
                type: "bold"
          ...
          // she isn't
          {
            block: [{
              text: [{
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/she-isnt1.mp3",
                part: "she "
              }, {
                part: "isn’t ",
                type: "bold"
              }, {
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/she-isnt2.mp3",
                part: "she "
              }, {
                part: "isn’(t) ",
                type: "bold"
          ...
          // it is not
          {
            block: [{
              text: [{
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/it-is-not1.mp3",
                part: "it "
              }, {
                part: "is not ",
                type: "bold"
              }, {
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/it-is-not2.mp3",
                part: "it "
              }, {
                part: "is no(t) ",
                type: "bold"
          ...
          // it's not
          {
            block: [{
              text: [{
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/its-not1.mp3",
                part: "it"
              }, {
                part: "’s not ",
                type: "bold"
              }, {
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/its-not2.mp3",
                part: "it"
              }, {
                part: "’s no(t) ",
                type: "bold"
          ...
          // it isn't
          {
            block: [{
              text: [{
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/it-isnt1.mp3",
                part: "it "
              }, {
                part: "isn’t ",
                type: "bold"
              }, {
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/it-isnt2.mp3",
                part: "it "
              }, {
                part: "isn’(t) ",
                type: "bold"
          ...
          // we are not
          {
            block: [{
              text: [{
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/we-are-not1.mp3",
                part: "we "
              }, {
                part: "are not ",
                type: "bold"
              }, {
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/we-are-not2.mp3",
                part: "we "
              }, {
                part: "are no(t) ",
                type: "bold"
          ...
          // we're not
          {
            block: [{
              text: [{
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/were-not1.mp3",
                part: "we"
              }, {
                part: "’re not ",
                type: "bold"
              }, {
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/were-not2.mp3",
                part: "we"
              }, {
                part: "’re no(t) ",
                type: "bold"
          ...
          // we aren't
          {
            block: [{
              text: [{
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/we-arent.mp3",
                part: "we "
              }, {
                part: "aren’t ",
                type: "bold"
          ...
          // they are not
          {
            block: [{
              text: [{
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/they-are-not1.mp3",
                part: "they "
              }, {
                part: "are not ",
                type: "bold"
              }, {
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/they-are-not2.mp3",
                part: "they "
              }, {
                part: "are no(t) ",
                type: "bold"
          ...
          // they're not
          {
            block: [{
              text: [{
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/theyre-not1.mp3",
                part: "they "
              }, {
                part: "’re not ",
                type: "bold"
              }, {
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/theyre-not2.mp3",
                part: "they "
              }, {
                part: "’re no(t) ",
                type: "bold"
          ...
          // they aren't
          {
            block: [{
              text: [{
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/they-arent1.mp3",
                part: "they "
              }, {
                part: "aren’t ",
                type: "bold"
              }, {
                audio: "/assets/audio/grammar/verb-be/pronunciation/negative/they-arent2.mp3",
                part: "they "
              }, {
                part: "aren’t ",
                type: "bold"
        ...
        <Section id="production" label="Production" heading={3}>
          ...
          value: ["What’s your occupation / job?"]
        }, {
          value: ["What’s your nationality?"]
        }]} />
        </Section>
      </div>
    </>;
