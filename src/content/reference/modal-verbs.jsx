...
export default function Blank() {
  return <>
      ...
      <div className="line-break">
        ...
        href: "possibility",
        label: "Possibility (May / Might / Could)"
      }, {
        href: "permission",
        label: "Permission (Can / May)"
      }, {
        href: "obligation",
        label: "Obligation (Must / Have to)"
      }, {
        href: "advice",
        label: "Advice (Should / Ought to)"
      }, {
        href: "exercises",
        label: "Exercises"
      }]} />
        ...
        <Section id="basic" label="Overview" heading={3}>
          ...
          part: "Verbos modais não mudam de forma e são seguidos pelo verbo na forma base (sem 'to').",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "can, could, may, might, must, should, will, would",
          type: "mark"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Você deve usar cinto de segurança.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="ability" label="Ability (Can / Could)" heading={3}>
          ...
          part: "Usamos can para habilidade no presente e could para o passado.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Ela sabia ler aos cinco anos.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="possibility" label="Possibility (May / Might / Could)" heading={3}>
          ...
          part: "Esses modais expressam possibilidade.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
        ...
        <Section id="permission" label="Permission (Can / May)" heading={3}>
          ...
          part: "Usamos can para permissão informal e may para situações formais.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
        ...
        <Section id="obligation" label="Obligation (Must / Have to)" heading={3}>
          ...
          part: "Must indica obrigação forte ou regra; have to indica obrigação externa.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Eu tenho que trabalhar amanhã.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="advice" label="Advice (Should / Ought to)" heading={3}>
          ...
          part: "Usamos should e ought to para dar conselhos.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Você deveria beber mais água.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Ela deveria descansar hoje.",
          type: "portuguese"
        }]} />
        </Section>
