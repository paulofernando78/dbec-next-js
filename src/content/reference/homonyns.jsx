  ...
  return <>
      ...
      <div className="line-break">
        ...
        <Section id="homographs" label="Homographs" heading={3}>
          ...
          part: "Por favor, lidere o caminho.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
        ...
        <Section id="true-homonyms" label="True Homonyms" heading={3}>
          ...
          part: "Eu fui ao banco sacar dinheiro.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Sentamos na margem do rio.",
          type: "portuguese"
        }]} />
        </Section>
