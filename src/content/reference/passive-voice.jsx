...
export default function Blank() {
  return <>
      ...
      <div className="line-break">
        ...
        href: "form",
        label: "Form (Be + Past Participle)"
      }, {
        href: "use",
        label: "When to Use Passive"
      }, {
        href: "tenses",
        label: "Passive in Different Tenses"
      }, {
        href: "exercises",
        label: "Exercises"
      }]} />
        ...
        <Section id="basic" label="Overview" heading={3}>
          ...
          part: "The house was built.",
          type: "bold"
        }, " ", {
          part: "Eles construíram a casa. → A casa foi construída.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="form" label="Form (Be + Past Participle)" heading={3}>
          ...
          part: "O e-mail foi enviado pelo gerente.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "O trabalho será terminado amanhã.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="use" label="When to Use Passive" heading={3}>
          ...
          part: "Minha bicicleta foi roubada.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "A estrada está sendo consertada.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="exercises" label="Exercises" heading={3}>
          ...
          questions: [{
            ...
            options: [{
              ...
              option: "has understand",
              isCorrect: false
            }]
          }, {
            question: "10. The phone ___ when I arrived.",
            options: [{
              option: "was being charged",
              isCorrect: true
            }, {
              option: "is charged",
              isCorrect: false
