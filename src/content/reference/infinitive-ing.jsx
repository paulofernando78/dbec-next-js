...
export default function InfinitiveIng() {
  return <>
      ...
      <div className="line-break">
        ...
        href: "change-meaning",
        label: "Verbs that Change Meaning"
      }, {
        href: "exercises",
        label: "Exercises"
      }]} />
        ...
        <Section id="basic" label="Overview" heading={3}>
          <Paragraph value={[{
          part: "Some verbs are followed by the infinitive (to + verb),",
          type: "bold"
          ...
          part: "Eu gosto de estudar inglês.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="infinitive" label="Infinitive (to + verb)" heading={3}>
          <Paragraph value={[{
          part: "We use the infinitive",
          type: "bold"
        }, " after many verbs, adjectives, and to show purpose.", " ", {
          part: "Usamos o infinitivo após muitos verbos, adjetivos e para mostrar propósito.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "want, decide, need, hope, plan, try",
          type: "mark"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Eu fui à loja para comprar leite.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="gerund" label="-ing (Gerund)" heading={3}>
          <Paragraph value={[{
          part: "We use the -ing form",
          type: "bold"
        }, " after certain verbs and as a noun.", " ", {
          part: "Usamos a forma -ing após certos verbos e como substantivo.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "enjoy, avoid, finish, keep, suggest, mind",
          type: "mark"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Nadar é bom para sua saúde.",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="change-meaning" label="Verbs that Change Meaning" heading={3}>
          <Paragraph value={[{
          part: "Some verbs change meaning",
          type: "bold"
        }, " depending on whether they are followed by the infinitive or the -ing form.", " ", {
          part: "Alguns verbos mudam de significado dependendo se são seguidos por infinitivo ou -ing.",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Eu lembrei de ligar para ela (ação depois).",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Eu lembro de ter ligado para ela (memória passada).",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Ele parou para fumar (parou outra coisa para fumar).",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          ...
          part: "Ele parou de fumar (cessou o hábito).",
          type: "portuguese"
        }]} />
        </Section>
