  ...
  return <>
      ...
      <div className="line-break">
        ...
        <Section id="basic" label="Basic Adjectives" heading={3}>
          ...
          part: "dois carros pequenos",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          part: "three old houses",
          type: "bold"
        }, " ", {
          part: "três casas velhas",
          type: "portuguese"
        }]} />
        </Section>
        ...
        <Section id="ing-ed" label="-ing vs. -ed" heading={3}>
          ...
          part: "Eu estou enojado(a).",
          type: "portuguese"
        }]} />
        </Section>

        <Section id="descriptive" label="-ing (Descriptive / Participial)" heading={3}>
          <Paragraph value={[{
          ...
          part: "living organisms",
          type: "bold"
        }, " ", {
          part: "organismos vivos",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          part: "a sleeping baby",
          type: "bold"
        }, " ", {
          part: "um bebê dormindo",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
        ...
        <Section id="compound" label="Compound" heading={3}>
          ...
          part: "a well-known actor",
          type: "bold"
        }, " ", {
          part: "um ator conhecido",
          type: "portuguese"
        }, {
          lineBreak: true
        }, {
          part: "a full-time job",
          type: "bold"
        }, " ", {
        ...
        <Section id="superlatives" label="Superlatives" heading={3}>
          ...
          part: "the farthest / the furthest",
          type: "bold"
        }, " ", {
          part: "o mais distante",
          type: "portuguese"
        }, " ", {
          lineBreak: true
        }, {
