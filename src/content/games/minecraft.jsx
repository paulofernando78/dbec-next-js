  ...
  return <>
      ...
      <div className="line-break">
        ...
        <Section id="basics" label="Basics" heading={3}>
          <Line value={[...instruction({
          parts: ["First things to do when game starts:", {
            part: "",
            type: ""
          }]
        })]} />
        ...
        <Section id="stone-phase" label="Stone Phase" heading={3}>
          <Line value={[...attention({
          parts: ["After collecting stones we can craft stone tools like:", {
            part: "",
            type: ""
          }]
        })]} />
        ...
        <Section id="" label="Get Food" heading={3}>
          ...
          parts: ["Kill animals to collect food to avoid starving.", {
            part: "",
            type: ""
          }],
          ...
          <Line value={[...attention({
          audio: "/assets/audio/general/.mp3",
          parts: ["Animals we shouldn’t kill:", {
            part: "",
            type: ""
          }],
          portugueseTranslation: ""
