...
export default function Travel() {
  return <>
      ...
      <div className="line-break">
        <Line text={[{
        part: "Common vocabulary for travel.",
        type: "bold"
      }]} />
        <Contents items={[{
        href: "packing",
        ...
        <Section id="packing" label="Packing" heading={3}>
          ...
          part: "fazer as malas / arrumar",
          type: "portuguese"
        }, " ", {
          bullet: true,
          part: "I need to pack my bags tonight."
        }, " ", {
          ...
          part: "itens de higiene",
          type: "portuguese"
        }, " ", {
          bullet: true,
          part: "Don't forget your toiletries."
        }, " ", {
          ...
          <Dialogue title="Packing at Home" audioPlayer="/assets/audio/dialogues/packing.mp3" lines={[{
          text: [{
            type: "italic",
          ...
          speaker: "A:",
          text: ["Have you finished packing yet? ", {
            part: "Você já terminou de fazer as malas?",
            type: "portuguese"
          }]
        }, {
          speaker: "B:",
          text: ["Almost. I still need to pack my toiletries and my travel documents. ", {
            part: "Quase. Ainda preciso arrumar meus itens de higiene e meus documentos de viagem.",
            type: "portuguese"
          }]
        }, {
          speaker: "A:",
          text: ["Don’t forget your charger. ", {
            part: "Não se esqueça do seu carregador.",
            type: "portuguese"
          }]
        }, {
          speaker: "B:",
          text: ["Good point. I’ll put them in my carry-on. ", {
            part: "Boa ideia. Vou colocá-los na minha bagagem de mão.",
            type: "portuguese"
          }]
        }, {
          speaker: "A:",
          text: ["Try to pack light. Airlines charge extra for heavy luggage. ", {
            part: "Tente viajar leve. As companhias aéreas cobram a mais por bagagem pesada.",
            type: "portuguese"
          }]
        }, {
          speaker: "B:",
          text: ["I know! I also brought a laundry bag to separate dirty clothes. ", {
            part: "Eu sei! Também trouxe um saco para separar as roupas sujas.",
            type: "portuguese"
          }]
        }, {
          speaker: "A:",
          text: ["Perfect. What time are we leaving for the airport? ", {
            part: "Perfeito. Que horas vamos sair para o aeroporto?",
            type: "portuguese"
          }]
        }, {
          speaker: "B:",
          text: ["In about an hour. Let’s double-check everything. ", {
        ...
        <Section id="travel-essentials" label="Travel Essentials" heading={3}>
          ...
          bullet: true,
          part: "I need my passport to check in."
        }, " ", {
          ...
          part: "hotel reservation",
          type: "bold"
        }, " ", {
          part: "reserva de hotel",
          type: "portuguese"
        }, " ", {
          bullet: true,
          ...
          <Dialogue title="Asking for Help in the City" audioPlayer="/assets/audio/dialogues/common-vocabulary.mp3" lines={[{
          text: [{
            type: "italic",
          ...
          speaker: "A:",
          text: ["Excuse me, can you give me directions to the hotel? ", {
            part: "Com licença, você pode me dar direções para o hotel?",
            type: "portuguese"
          }]
        }, {
          speaker: "B:",
          text: ["Sure. Go straight, then turn left at the restaurant. ", {
            part: "Claro. Vá em frente e depois vire à esquerda no restaurante.",
            type: "portuguese"
          }]
        }, {
          speaker: "A:",
          text: ["Thank you. Is there a map I can use? ", {
            part: "Obrigado(a). Há um mapa que eu possa usar?",
            type: "portuguese"
          }]
        }, {
          speaker: "B:",
          text: ["Yes, you can find one at the tourist center. ", {
        ...
        <Section id="At the airport" label="at-the-airport" heading={3}>
          ...
          <Dialogue title="At the Airport Check-in" audioPlayer="/assets/audio/dialogues/travel-essentials.mp3" lines={[{
          text: [{
            type: "italic",
          ...
          speaker: "B:",
          text: ["Here you are. I also have my boarding pass. ", {
          ...
          <Dialogue title="Finding Your Seat" audioPlayer="/assets/audio/dialogues/inside-the-plane.mp3" lines={[{
          text: [{
            type: "italic",
          ...
          speaker: "A:",
          text: ["Excuse me, is this seat 14A? ", {
            part: "Com licença, este é o assento 14A?",
            type: "portuguese"
          }]
        }, {
          speaker: "B:",
          text: ["Yes, that’s the window seat. Your seatbelt is under the armrest. ", {
            part: "Sim, é o assento da janela. Seu cinto de segurança está sob o apoio de braço.",
            type: "portuguese"
          }]
        }, {
          speaker: "A:",
          text: ["Thank you. Where can I put my bag? ", {
            part: "Obrigado(a). Onde posso colocar minha bolsa?",
            type: "portuguese"
          }]
        }, {
          speaker: "B:",
          text: ["Please place it in the overhead bin. ", {
        ...
        <Section id="inside-the-plane" label="Inside the Plane" heading={3}>
          ...
          bullet: true,
          part: "My seat is near the window."
        }, " ", {
          ...
          part: "cinto de segurança",
          type: "portuguese"
        }, " ", {
          bullet: true,
          part: "Please fasten your seatbelt."
        }, " ", {
          ...
          part: "flight attendant",
          type: "bold"
        }, " ", {
          part: "comissário(a) de bordo",
          type: "portuguese"
        }, " ", {
          bullet: true,
          ...
          bullet: true,
          part: "Please fold your tray table."
        }, " ", {
        ...
        <Section id="common-vocabulary" label="Common Vocabulary" heading={3}>
          ...
          part: "bilhete / passagem",
          type: "portuguese"
        }, " ", {
          bullet: true,
          part: "I bought my ticket online."
        }, " ", {
