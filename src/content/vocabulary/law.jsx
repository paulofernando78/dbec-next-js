...
export default function Law() {
  return <>
      ...
      <div className="line-break">
        <Line text={[{
        part: "Common law and legal terms.",
        type: "bold"
      }]} />
        <Contents items={[{
        ...
        <Section id="court-and-procedure" label="Court & Procedure" heading={3}>
          ...
          part: "julgamento / julgamento judicial",
          type: "portuguese"
        }, " ", {
          bullet: true,
          part: "The trial will start next Monday."
        }, {
          ...
          bullet: true,
          part: "The judge scheduled a hearing for Friday."
        }, {
          ...
          part: "veredicto / decisão",
          type: "portuguese"
        }, " ", {
          bullet: true,
          part: "The jury reached a verdict after three hours."
        }, {
          ...
          part: "recurso / apelação",
          type: "portuguese"
        }, " ", {
          bullet: true,
          part: "The lawyer filed an appeal."
        }, {
