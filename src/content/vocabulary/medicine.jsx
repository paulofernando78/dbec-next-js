...
export default function Medicine() {
  return <>
      ...
      <div className="line-break">
        <Line text={[{
        part: "Common medical and healthcare vocabulary.",
        type: "bold"
      }]} />
        <Contents items={[{
        ...
        <Section id="medical-professionals" label="Medical Professionals" heading={3}>
          <Paragraph value={[{
          part: "anesthesiologist",
          type: "bold"
        }, " ", {
          part: "anestesiologista",
          type: "portuguese"
        }, " ", {
          bullet: true,
        ...
        <Section id="procedures-and-treatment" label="Procedures & Treatment" heading={3}>
          ...
          part: "cesarean / caesarean",
          type: "bold"
        }, " ", {
          part: "cesariana / parto cesáreo",
          type: "portuguese"
        }, " ", {
          bullet: true,
