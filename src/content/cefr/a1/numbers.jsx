      ...
      <div className="line-break">
        <PageSections>
          ...
          <Section id="presentation" heading={3}>
            <Dialogue
              audioPlayer="/assets/audio/vocabulary/numbers/presention-dialogue.mp3"
              lines={[
                {
                  speaker: "Eric:",
                  text: [
                ...
                },
                {
                  ...
                  text: [
                    ...content({
                      parts: ["Great! Let's sing Happy birthday, then."],
                    }),
                  ],
                },
              ]}
