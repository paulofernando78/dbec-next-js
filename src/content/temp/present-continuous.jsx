  ...
  return <>
      ...
      <div className="line-break">
        ...
        <Section id="introduction" label="Introduction" heading={3}>
          ...
          lines: [{
            value: [{
              audio: "/assets/audio/grammar/present-continuous/introduction/mr-smith-is-teaching.mp3"
          ...
          lines: [{
            value: [{
              audio: "/assets/audio/grammar/present-continuous/introduction/students-are-looking-at-a-picture-in-a-book.mp3"
          ...
          lines: [{
            value: [{
              audio: "/assets/audio/grammar/present-continuous/introduction/people-are-wearing-swimsuits.mp3"
          ...
          lines: [{
            value: [{
              audio: "/assets/audio/grammar/present-continuous/introduction/people-are-wearing-warm-clothes.mp3"
          ...
          lines: [{
            value: [{
              audio: "/assets/audio/grammar/present-continuous/introduction/students-are-speaking-to-one-another.mp3"
        ...
        <Section id="presentation" label="Presentation" heading={3}>
          ...
          <Dialogue audioPlayer="/assets/img/grammar/present-continuous/presentation/dialogue.mp3" lines={[{
          speaker: "Mr. Smith:",
          text: ["Good evening everyone. How are you doing? Ready for today’s class?"]
        }, {
          speaker: "Eric:",
          text: ["Yes, Mr. Smith."]
        }, {
          ...
          speaker: "Mr. Smith:",
          text: ["Please, open your book on page 12. What can you see in picture 1?"]
        }, {
          speaker: "Laura:",
          text: ["In picture 1, people are wearing swimsuits because they’re on the beach. Some people are swimming in the ocean."]
        }, {
          speaker: "Mr. Smith:",
          text: ["How about picture 2?"]
        }, {
          speaker: "Eric:",
          text: ["In picture 2, people are wearing warm clothes because it’s winter and it’s snowing."]
        }, {
          speaker: "Mr. Smith:",
          text: ["Now stand up. Talk to your partner and tell them what you’re wearing."]
        }, {
          speaker: "",
          text: [{
        ...
        <Section id="meaning" label="Meaning" heading={4}>
          <Paragraph value={[{
          audio: "/assets/audio/grammar/simple-present/meaning/.mp3",
        ...
        <Section id="pronunciation-form" label="Pronunciation + Form" heading={4}>
          <Column length="4" width="370" cols={[
        // Affirmative
        {
          bgColor: "var(--green-6)",
          column: "Affirmative",
        ...
        <Section id="practice" label="Practice" heading={3}>
          ...
          instructions: "Fill in the blanks with verb be + present continuous form.",
          blocks: [{
            block: [{
              text: "1. I"
            }, {
        ...
        <Section id="production" label="Production" heading={3}>
          ...
          value: ["What is your teacher doing now?"]
        }, {
          value: ["What are your classmates doing?"]
        }]} />
        </Section>
      </div>
    </>;
